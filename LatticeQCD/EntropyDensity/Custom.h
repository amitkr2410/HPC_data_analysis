...
void Custom(TGraph *h1, int color)
{
  gPad->SetTickx();
  gPad->SetTicky();
  h1->SetMarkerColor(color);
...
void Custom(TGraphErrors *h1, int color)
{
  gPad->SetTickx();
  gPad->SetTicky();
  h1->SetMarkerColor(color);
...
void Custom(TGraphErrors *h1, int color, int style)
{
  gPad->SetTickx();
  gPad->SetTicky();
