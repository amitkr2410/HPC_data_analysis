...
int main(int argc, char *argv[])  
{
  ...
  complex CurrentTraceF3iF3i, SumTraceF3iF3i=cmplx(0.0,0.0), AverageTraceF3iF3i;
  complex CurrentTraceF4iF4i, SumTraceF4iF4i=cmplx(0.0,0.0), AverageTraceF4iF4i;
  ...
  FILE *fploop, *ftracefmunuLO, *ftracefmunuNLO, *ftracefmunuNNLO, *ftracefmunuEB; 
  char FileNamePloop[10000], FileNameTraceFmunuEB[1000], FileNameTraceFmunu[10000], FileNameTraceFmunu2[10000], FileNameTraceFmunu3[10000], FileNameTraceFmunu4[10000], SaveLatticeFileName[100000], ReadLatticeFileName[100000], FolderName[10000];
  ...
  while( readin(prompt) == 0)
    {
      ...
      sprintf(FileNameTraceFmunuEB,"%s/DataTraceFmunuEB_Clover_Traceless_Nt%d_Ns%d_Beta%.4f.txt",OutputDataFileDIR, nt, nx, beta);
      ...
      ftracefmunuEB = fopen(FileNameTraceFmunuEB,"w");
      ...
      fprintf(ftracefmunuEB, "#Beta=%.4f, Nt=%d, Ns=%d^3 \n", beta, nt, nx);
      fprintf(ftracefmunuEB, "#Iters \t AvgTrF3i3i.Re \t AvgTrF4iF4i.Re \t AvgTrF3i3iMinusF4iF4i \n");
	  ...
	  if(iters ==500) 
	    {
	      ...
	      SumTraceF3iF3i = cmplx(0.0,0.0); SumTraceF4iF4i = cmplx(0.0,0.0);
	    }
	  ...
	  if(ComputeTraceFmunu==1)
	    {
	      ...
	      CurrentTraceF3iF3i = cmplx(0.0,0.0);  CurrentTraceF4iF4i = cmplx(0.0,0.0);

              fmunu_fmunu(&CurrentTraceF3iF3i, &CurrentTraceF4iF4i, &CurrentSymmetricTadpole0, &CurrentSymmetricTadpole2, &CurrentSymmetricTadpole4, &CurrentAntiSymmetricTadpole0, &CurrentAntiSymmetricTadpole2, &CurrentAntiSymmetricTadpole4);
	      
	      CADD(SumTraceF3iF3i, CurrentTraceF3iF3i, SumTraceF3iF3i);
	      CADD(SumTraceF4iF4i, CurrentTraceF4iF4i, SumTraceF4iF4i);
	      ...
	      CDIVREAL(SumTraceF3iF3i, MeasurementCount, AverageTraceF3iF3i);
	      CDIVREAL(SumTraceF4iF4i, MeasurementCount, AverageTraceF4iF4i);
	      ...
	      printf("Amit MyFFApp/control.c TraceF3iF3i=(%e,%e), AvgTrace=(%e,%e) \n", CurrentTraceF3iF3i.real, CurrentTraceF3iF3i.imag, AverageTraceF3iF3i.real, AverageTraceF3iF3i.imag);
	      printf("Amit MyFFApp/control.c TraceF4iF4i=(%e,%e), AvgTrace=(%e,%e) \n", CurrentTraceF4iF4i.real, CurrentTraceF4iF4i.imag, AverageTraceF4iF4i.real, AverageTraceF4iF4i.imag);
	      ...
	      fprintf(ftracefmunuEB, "%d \t %e \t %e \t %e \n", iters, AverageTraceF3iF3i.real, AverageTraceF4iF4i.real, AverageSymmetricTadpole0.real);
