...
void fmunu_fmunu(complex *TraceF3iF3i, complex *TraceF4iF4i, complex *SymmetricTadpole0, complex *SymmetricTadpole2, complex *SymmetricTadpole4, complex *AntiSymmetricTadpole0, complex *AntiSymmetricTadpole2, complex *AntiSymmetricTadpole4)
{
  ...
  //*time = *space = *charge = 0;
  *TraceF3iF3i = cmplx(0.0,0.0);
  *TraceF4iF4i = cmplx(0.0,0.0);
  ...
  *AntiSymmetricTadpole4=cmplx(0.0,0.0);  
  ...
  FORALLSITES(i, s) 
      ...
      for(int k=0; k<8; k++)
	{
      ...
      CADD(*TraceF3iF3i, trace_nn(&(s->fieldstrength[1]), &(s->fieldstrength[1])) , *TraceF3iF3i);
      CADD(*TraceF3iF3i, trace_nn(&(s->fieldstrength[2]), &(s->fieldstrength[2])) , *TraceF3iF3i);
      CADD(*TraceF4iF4i, trace_nn(&(s->fieldstrength[3]), &(s->fieldstrength[3])) , *TraceF4iF4i);
      CADD(*TraceF4iF4i, trace_nn(&(s->fieldstrength[4]), &(s->fieldstrength[4])) , *TraceF4iF4i);
      //printf("\t TraceF4iF3iPlusF3iF4i = ");Display(*TraceF4iF3iPlusF3iF4i);
    }

  g_complexsum(TraceF3iF3i);
  g_complexsum(TraceF4iF4i);
  ...
  CMULREAL(*TraceF3iF3i, Normalization, *TraceF3iF3i);
  CMULREAL(*TraceF4iF4i, Normalization, *TraceF4iF4i);
  ...
  printf("\n Total TraceF3iF3i = "); Display(*TraceF3iF3i);
  printf("\n Total TraceF4iF4i = "); Display(*TraceF4iF4i);
