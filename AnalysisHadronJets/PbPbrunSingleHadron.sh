...
K=$1           #i=0, 1, 2, 3, 4
for (( i=0;i<2;i++ )) #i=0, 1,     2, 3       4,5
do

PPorPbPb=PbPb     # pp or PbPb
BGS=1             # 0 or  1
...
FileNameOutPut=${Hadronization[$i]}SingleHadronYield_${PPorPbPb}_${MC[$i]}_${Exp}_${Ecm}GeV_EtaMax_${SingleHadronEtaCutS}_FS_${ChargedFlagName[$i]}${Matter[$i]}${ElossName}
...
HadronDirectoryRun=/wsu/tmp/AmitJETSCAPE/PbPb5TeV${ElossName}
