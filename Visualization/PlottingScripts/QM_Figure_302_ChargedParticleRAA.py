...
files_aa_theory = [ '../ColorlessSingleHadronYield_PbPb_Jetscape_CMS_5020GeV_EtaMax_1p0_FS_ChargedHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1.txt', '../DifferentQhat/ColorlessSingleHadronYield_PbPb_Jetscape_CMS_5020GeV_EtaMax_1p0_FS_ChargedHadron_Cent_0-10_MatterLBT_withRecoil_RunningCouplingNewMoreStatistics_BGS1.txt']
...
OutputFilename='../Plots/QM_ChargedParticle_RAA_different_Qhat_5020GeV_CMS_0-10_eta1p0.pdf'
x_min =8.0
x_max =450
y_min = 0
y_max = 1.7
...
axs.legend(handles,labels,ncol=1,loc='center left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.2, bbox_to_anchor=(0, 0.675), borderaxespad=0.8, handlelength=1.6, fontsize=12)
...
axs.text(x_max-80, y_min+0.08,'$Q_\mathrm{sw}=\mathrm{2~GeV}$\n $~\mathrm{Running\,Coupling}$',horizontalalignment='right', verticalalignment='bottom')
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
