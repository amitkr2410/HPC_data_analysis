...
color_theory = ['red','green','blue','magenta']
line_theory = ['solid','solid','solid', 'dashed']
...
##--
file_pp_theory = ['../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_LiquefierEcut4T_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allHadron_Cent_0-10_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt' ]

files_aa_theory = ['../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allParton_Cent_0-10_MatterLBT_withRecoil_LiquefierEcut4T_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allParton_Cent_0-10_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt']

# '../200GeV/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt',          '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allParton_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt',  '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_LiquefierEcut4T_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allParton_Cent_0-10_MatterLBT_withRecoil_LiquefierEcut4T_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt' ]     

label_theory = [ '$\mathrm{PbPb~Jet~}(Liquefier~Ecut=4T)$', '$\mathrm{PP~Jet~}$']
    #r'$\mathrm{Hadronic~Jet~(Default)}$', '$\mathrm{Partonic~Jet~(Default)}$', '$\mathrm{Hadronic~Jet~(Liquefier~Ecut=4T)}$', '$\mathrm{Partonic~Jet~(Liquefier~Ecut=4T)}$' ]

files_data = ['']

label_data = ['$\mathrm{STAR~[PRC~102,~054913~(2020)]}$']
OutputFilename='../Plots/InclusiveJet_AuAu_200GeV_STAR_R0p4_eta1p0_LiquefierEcut4T.pdf'
x_min =7.0
x_max =42
y_min = 0.8
y_max = 3.0
...
axs.set_ylabel(r'$\frac{Partonic}{Hadronic}[\frac{d^{2}\sigma}{d\eta d p^{\mathrm{jet}}_{\mathrm{T}}}]$', fontsize=16)
...
axs.legend(handles,labels,ncol=1,loc='center left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.6, labelspacing=0.2, bbox_to_anchor=(0, 0.7), borderaxespad=0.8, handlelength=1.6, fontsize=12)


## Text
axs.text(x_min+1.2, y_max-0.5, '$\mathrm{AuAu~(0\\text{-}10\%),~\sqrt{\it{s}_{NN}}\!=\!200~GeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~R\!=\!0.4, |\eta_{jet}|<1.0$\n' , horizontalalignment='left', verticalalignment='bottom', fontsize=12)
axs.text(x_max-3, y_min+0.05,'$\mathrm{JS(MATTER+LBT)}$ \n $\\hat{q}=\hat{q}^{run}_{HTL}f(Q^{2})$ \n $\mathrm{\\alpha^{fix}_{s}\!=\!0.3},~Q_{sw}\!=\!2\!~\mathrm{GeV}$',horizontalalignment='right', verticalalignment='bottom', fontsize=12)
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
