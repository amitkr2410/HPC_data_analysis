...
##--
file_denom = '../JetCrossSection_R_0p4_AntikT_pp_Pythia_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron.txt'

files_theory = [
                '../ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_pTTrackMin_0p0GeV.txt',
                '../JetCrossSection_R_0p4_AntikT_pp_Pythia_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron.txt']

label_theory = [r'$\mathrm{JETSCAPE~1.0~(Colorless~Had.)}$',
                r'$\mathrm{PYTHIA~8}$']
...
OutputFilename='../Plots/RatioPlot_DJCS_5020GeV_ATLAS_R0p4_y0p3.pdf'
########################################################################################################################################################          
