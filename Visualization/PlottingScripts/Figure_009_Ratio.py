...
##--
file_denom = '../200GeV/JetCrossSection_R_0p6_AntikT_pp_Pythia_Star_200GeV_EtaJetMin_0p0_EtaMax_0p5_FS_allHadron.txt'

files_theory = [
                '../200GeV/ColorlessJetCrossSection_R_0p6_AntikT_pp_Jetscape_Star_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allHadron_pTTrackMin_0p0GeV.txt',
                '../200GeV/JetCrossSection_R_0p6_AntikT_pp_Pythia_Star_200GeV_EtaJetMin_0p0_EtaMax_0p5_FS_allHadron.txt']

label_theory = [r'$\mathrm{JETSCAPE~3.0}$',
                r'$\mathrm{PYTHIA~8}$']

files_data = ['../../ExperimentData_All/ExpData_STAR_200_JetCrosssection_ppbaseline_Rp6_eta0p5.dat']
#ATLAS PLB 790, 108 (2019)
label_data = ['$\mathrm{STAR~[PoS~DIS2015,~203~(2015)]}$']
OutputFilename='../Plots/RatioPlot_DJCS_200GeV_STAR_R0p6_eta0p5.pdf'
########################################################################################################################################################          
...
axs.set_ylabel(r'$\mathrm{Ratio~to~PYTHIA~8}~\left[\frac{d^2 \sigma}{dy dp_{\mathrm{T}}^{\mathrm{jet}}}\right]$', fontsize=19)
