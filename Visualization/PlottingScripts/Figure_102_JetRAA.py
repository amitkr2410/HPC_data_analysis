...
##--
file_pp_theory = '../ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_BGS0.txt'

files_aa_theory = ['../ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../DifferentQhat/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_RunningCouplingNewMoreStatistics_BGS1_pTTrackMin_0p0GeV.txt', '../DifferentQhat/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_alphas_0p25_Q0_2p0_BGS1.txt']
...
OutputFilename='../Plots/Jet_RAA_5020GeV_different_Qhat_ATLAS_CMS_R0p4_eta2p8.pdf'
x_min =80.0
x_max =1210
y_min = 0
y_max = 1.2
...
axs.legend(handles,labels,ncol=1,loc='center left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.5, labelspacing=0.2, bbox_to_anchor=(0, 0.75), borderaxespad=0.8, handlelength=1.6, fontsize=14)


## Text
axs.text(x_max-80, y_min+0.23, '$\mathrm{PbPb~(0\\text{-}10\%),~\sqrt{\it{s}_\mathrm{NN}}=5.02~TeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~ R=0.4,~|y_{\mathrm{jet}}|<2.8$' , horizontalalignment='right', verticalalignment='bottom')
...
plt.savefig('temp2')
## Add Logos
add_jetscape_logo('temp2',80,70,80,'_logo')
os.remove('temp.pdf')
