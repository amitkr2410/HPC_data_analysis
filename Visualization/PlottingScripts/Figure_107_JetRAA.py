...
files_aa_theory =[                  '../Liquefier_BroadeningEcut8T/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Liqu_3p2T_Broad_8TType5_alphas_0p35_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../Liquefier_BroadeningEcut8T/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allParton_Cent_0-10_MatterLBT_withRecoil_Liqu_3p2T_Broad_8TType5_alphas_0p35_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt' ]
...
OutputFilename='../Plots/Jet_RAA_5020GeV_Type5_Liq3p2T_Broad_8T_Cent0-10_ATLAS_CMS_R0p4_eta2p8.pdf'
x_min =80.0
x_max =1210
y_min = 0.0
y_max = 1.2
...
axs.text(x_max-60, y_min+0.02,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $\\hat{q}\!\!=\!\!\\hat{q}^{run}_{HTL}f(Q^{2}),~\mathrm{\\alpha^{fix}_{s}\!\!=\!\!0.35}$,~$Q_{sw}\!=\!2~\!\mathrm{GeV}$ \n $~\mathrm{Parton~Ecut=3.2T},~\mathrm{Correlated~Broadening~Ecut=8T}$ ', horizontalalignment='right', verticalalignment='bottom',fontsize=11)
