...
##--
files_theory = ['../ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_pTTrackMin_0p0GeV.txt',
              '../ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron.txt',
              '../ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_BGS0_pTTrackMin_0p0GeV.txt']
label_theory = [r'$(|y_{\mathrm{jet}}|<0.3)\times10^3$',
                r'$(|y_{\mathrm{jet}}|<2.8)\times10^2$',
                r'$(|\eta_{\mathrm{jet}}|<0.3, p^{\mathrm{lead,ch}}_{\mathrm{T}}>7~\!\mathrm{GeV})$']              

files_data = ['../../ExperimentData_All/ExpData_ATLAS_5020_JetCrosssection_R0p4_y0p3.dat',
              '../../ExperimentData_All/ExpData_ATLAS_5020_JetCrosssection_R0p4_y2p8.dat',
              '../../ExperimentData_All/ExpData_ALICE_5020_JetCrosssection_R0p4_eta0p3.dat']

label_data = ['$\mathrm{ATLAS}$','$\mathrm{ATLAS}$','$\mathrm{ALICE}$']
OutputFilename='../Plots/Spectrum_DJCS_5020GeV_ATLAS_ALICE_ATLAS.pdf'
########################################################################################################################################################          
