...
##--
file_pp_theory = 'RAA_Plot/ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_BGS0.txt'

files_aa_theory = ['RAA_Plot/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt',
                   'RAA_Plot/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_RunningCouplingNewMoreStatistics_BGS1_pTTrackMin_0p0GeV.txt',
                   'RAA_Plot/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt']
...
files_data = ['RAA_Plot/ExpData_ATLAS_5020_JetRAA_Cent0-10_R0p4_y2p8.dat',
              'RAA_Plot/ExpData_CMS_5020_JetRAA_Cent0-10_R0p4_eta2p0.dat']

label_data = ['$\mathrm{ATLAS~[PLB~790,~108~(2019)]}$',
              '$\mathrm{CMS~[Preliminary],}~|\eta_{\mathrm{jet}}<2.0|$']    
########################################################################################################################################################          
...
## Domain and Range
x_min = 100*pow(10,-0.1)
x_max = 1000*pow(10,0.1)
y_min = 0
y_max = 1.0
...
axs.legend(handles,labels,ncol=1,loc='lower right',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.3, bbox_to_anchor=(1, 0), borderaxespad=0.5, handlelength=1.6, fontsize=11)

## Text
axs.text(1.2*x_min,0.95*y_max, '$\mathrm{PbPb~(0\\text{-}10\%)~5.02~TeV}$\n'+r'$\mathrm{anti\text{-}}k_t$, $R\!=\!0.4$'+'\n'+'$|y_{\mathrm{jet}}|<2.8$', horizontalalignment='left', verticalalignment='top')

## Generate PDF File
plt.tight_layout()
plt.savefig('plot_template_jet_raa')
## Add Logos
add_jetscape_logo('plot_template_jet_raa',85,85,80,'_logo')
os.remove('plot_template_jet_raa.pdf')
os.system('open plot_template_jet_raa_logo.pdf')
########################################################################################################################################################
