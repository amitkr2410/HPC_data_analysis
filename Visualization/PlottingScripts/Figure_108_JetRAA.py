...
files_aa_theory =[                  '../Liquefier_BroadeningEcut10T/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Liqu_3p2T_Broad_10TType5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../Liquefier_BroadeningEcut10T/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allParton_Cent_0-10_MatterLBT_withRecoil_Liqu_3p2T_Broad_10TType5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt' ]

                   
label_theory = [ '$\mathrm{Hadronic~Jet}$', '$\mathrm{Partonic~Jet}$'] 
...
OutputFilename='../Plots/Jet_RAA_5020GeV_Type5_Liq3p2T_Broad_10T_Cent0-10_ATLAS_CMS_R0p4_eta2p8.pdf'
x_min =80.0
x_max =1210
y_min = 0.0
y_max = 1.2
...
for i, file in enumerate(files_aa_theory):
    ...
    axs.legend(handles,labels,ncol=1,loc='center left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.3, labelspacing=0.2, bbox_to_anchor=(0, 0.8), borderaxespad=0.8, handlelength=1.6, fontsize=12)


## Text
axs.text(x_max-80, y_min+0.22, '$\mathrm{PbPb~(0\\text{-}10\%),~\sqrt{\it{s}_{NN}}=5.02~TeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~ R=0.4,~|y_{\mathrm{jet}}|<2.8$' , horizontalalignment='right', verticalalignment='bottom',fontsize=11)
axs.text(x_max-60, y_min+0.02,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $\\hat{q}\!\!=\!\!\\hat{q}^{run}_{HTL}f(Q^{2}),~\mathrm{\\alpha^{fix}_{s}\!\!=\!\!0.3}$,~$Q_{sw}\!=\!2~\!\mathrm{GeV}$ \n $~\mathrm{Parton~Ecut=3.2T},~\mathrm{Correlated~Broadening~Ecut=10T}$ ', horizontalalignment='right', verticalalignment='bottom',fontsize=11)
