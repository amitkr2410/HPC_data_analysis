...
##
file_pp_theory = '../WithHoleSubtraction_5020GeV/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_30-40_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt'

files_aa_theory =['../WithHoleSubtraction_5020GeV/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_30-40_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../WithoutHoleSubtraction_5020GeV/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_30-40_Matter_Type5_alphas_0p3_Q0_2GeV_BGS0_pTTrackMin_0p0GeV.txt']
                   
label_theory = [r'$\mathrm{with~holes~subtraction}$', '$\mathrm{without~holes~subtraction}$']

files_data = ['../../ExperimentData_All/ExpData_ATLAS_5020_JetRAA_Cent30-40_R0p4_y2p8.dat']

label_data = ['$\mathrm{ATLAS~[PLB~790,~108~(2019)]}$']
OutputFilename='../Plots/Jet_RAA_5020GeV_Type5_Effect_Holes_Cent30-40_ATLAS_R0p4_eta2p8.pdf'
x_min =70.0
x_max =720
y_min = 0.2
y_max = 1.2
