...
##--
file_pp_theory = ['../200GeV/JetFiles/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allHadron_Cent_0-10_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt', '../200GeV/JetFiles/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allHadron_Cent_0-10_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt']

files_aa_theory = ['../200GeV/JetFiles/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../200GeV/JetFiles/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_1p0_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt']
                   

label_theory = [r'$|\eta_{\mathrm{jet}}|\!<\! 0.5$', r'$|\eta_{\mathrm{jet}}|\!<\! 1.0$']

files_data = ['']

label_data = ['$\mathrm{STAR~[PRC~102,~054913~(2020)]}$']
OutputFilename='../Plots/InclusiveJet_RAA_200GeV_STAR_R0p4_eta0p5_eta1p0.pdf'
x_min =7.0
x_max =42
y_min = -0.2
y_max = 1.0
...
axs.legend(handles,labels,ncol=1,loc='center left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.2, bbox_to_anchor=(0, 0.7), borderaxespad=0.8, handlelength=1.6, fontsize=14)
