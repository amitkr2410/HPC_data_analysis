...
##--
file_pp_theory = '../2760GeV/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_CMS_2760GeV_EtaJetMin_0p0_EtaJetMax_2p0_FS_allHadron_Cent_0-5_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt'

files_aa_theory = ['../2760GeV/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_CMS_2760GeV_EtaJetMin_0p0_EtaJetMax_2p0_FS_allHadron_Cent_0-5_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt']
                   
label_theory = [r'$\hat{q}=\hat{q}^{run}_{HTL}f(Q^{2}), \mathrm{JS(MATTER+LBT) }$']

files_data = ['../../ExperimentData_All/ExpData_CMS_2760_JetRAA_Centrality0-5_R0p4_eta2p0.dat']

label_data = ['$\mathrm{CMS~[PRC~96,~015202~(2017)]}$']
OutputFilename='../Plots/Jet_RAA_2760GeV_CMS_R0p4_eta2p0.pdf'
x_min =50.0
x_max =310
y_min = 0
y_max = 1.5
...
## Text
axs.text(x_min+10, y_max-0.28, '$\mathrm{PbPb~(0\\text{-}5\%),~\sqrt{\it{s}_{NN}}=2.76~TeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~ R=0.4,~|\eta_{\mathrm{jet}}|<2$' , horizontalalignment='left', verticalalignment='bottom')
axs.text(x_min+35, y_max-0.69,'$\mathrm{\\alpha^{fix}_{s}=0.3},~Q_{sw}=2~\mathrm{GeV}$',horizontalalignment='left', verticalalignment='bottom')
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
