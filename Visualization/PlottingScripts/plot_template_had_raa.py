...
##--
file_pp_theory = 'RAA_Plot/ColorlessSingleHadronYield_pp_Jetscape_CMS_5020GeV_EtaMax_1p0_FS_ChargedHadron_BGS0.txt'

files_aa_theory = ['RAA_Plot/ColorlessSingleHadronYield_PbPb_Jetscape_CMS_5020GeV_EtaMax_1p0_FS_ChargedHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1.txt',
                   'RAA_Plot/ColorlessSingleHadronYield_PbPb_Jetscape_CMS_5020GeV_EtaMax_1p0_FS_ChargedHadron_Cent_0-10_MatterLBT_withRecoil_RunningCouplingNewMoreStatistics_BGS1.txt',
                   'RAA_Plot/ColorlessSingleHadronYield_PbPb_Jetscape_CMS_5020GeV_EtaMax_1p0_FS_ChargedHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1.txt']
...
files_data = ['RAA_Plot/ExpData_CMS_5020_ChargedHadron_Raa_Eta1p0_Cent0-10.dat']
...
axs.set_ylabel(r'$R_{\mathrm{AA}}^{\mathrm{h}^{\pm}}$', fontsize=16)
...
axs.legend(handles,labels,ncol=1,loc='upper left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.1, bbox_to_anchor=(0, 0.75), borderaxespad=0.5, handlelength=1.6, fontsize=11)

## Text
axs.text(1.2*x_min,0.95*y_max, '$\mathrm{PbPb~(0\\text{-}10\%)~5.02~TeV}$'+'\n'+'$|\eta|<1.0$', horizontalalignment='left', verticalalignment='top')

## Generate PDF File
plt.tight_layout()
plt.savefig('plot_template_had_raa')
## Add Logos
add_jetscape_logo('plot_template_had_raa',320,245,80,'_logo')
os.remove('plot_template_had_raa.pdf')
os.system('open plot_template_had_raa_logo.pdf')
########################################################################################################################################################
