...
##--
file_pp_theory = 'RAA_Plot/ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_BGS0_pTTrackMin_0p0GeV.txt'

files_aa_theory = ['RAA_Plot/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt',
                   'RAA_Plot/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_RunningCouplingNewMoreStatistics_BGS1_pTTrackMin_0p0GeV.txt',
                   'RAA_Plot/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt']

label_theory = [r'$\mathrm{w/~}Q^2\mathrm{\text{-}dependent}$',
                r'$\mathrm{w/o~}Q^2\mathrm{\text{-}dependent}$',
                r'$\mathrm{w/~}Q^2\mathrm{\text{-}dependent (dummy)}$']

files_data = ['RAA_Plot/ExpData_ALICE_5020_JetRAA_Cent0-10_R0p4_eta0p3.dat']

label_data = ['$\mathrm{ALICE~[PRC~101,~034911~(2020)]}$']    
########################################################################################################################################################          
...
## Domain and Range
x_min = 60-10#pow(10,-0.1)
x_max = 140+10#pow(10,0.1)
y_min = 0
y_max = 1.0
...
axs.set_ylabel(r'$R_{\mathrm{AA}}^{\mathrm{jet}}$', fontsize=16)
...
axs.legend(handles,labels,ncol=1,loc='upper left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.2, bbox_to_anchor=(0, 1), borderaxespad=0.8, handlelength=1.6, fontsize=11)

## Text
axs.text(0.98*x_max,0.05*y_max, '$\mathrm{PbPb~(0\\text{-}10\%)~5.02~TeV}$\n'+r'$\mathrm{anti\text{-}}k_t$, $R\!=\!0.4$'+'\n'+'$|\eta_{\mathrm{jet}}|<0.3,~p_{\mathrm{T}}^{\mathrm{lead}}>7~\mathrm{GeV}$', horizontalalignment='right', verticalalignment='bottom')

## Generate PDF File
plt.tight_layout()
plt.savefig('plot_template_jet_raa_alice')
## Add Logos
add_jetscape_logo('plot_template_jet_raa_alice',320,235,80,'_logo')
os.remove('plot_template_jet_raa_alice.pdf')
os.system('open plot_template_jet_raa_alice_logo.pdf')
########################################################################################################################################################
