...
##--
file_denom = '../PythiaSingleHadronYield_pp_Pythia_STAR_200GeV_EtaMax_0p35_FS_ChargedHadron'

files_theory = [
                '../ColorlessSingleHadronYield_pp_Jetscape_STAR_200GeV_EtaMax_0p35_FS_ChargedHadron.txt',
                '../PythiaSingleHadronYield_pp_Pythia_STAR_200GeV_EtaMax_0p35_FS_ChargedHadron.txt']

label_theory = [r'$\mathrm{JETSCAPE~3.0}$',
                r'$\mathrm{PYTHIA~8}$']

files_data = ['../../ExperimentData_All/ExpData_PHENIX_200GeV_NeutralPionCrosssection_ppbaseline.dat']
#ATLAS PLB 790, 108 (2019)
label_data = ['$\mathrm{PHENIX~[PRD~76,~051106~(2007)]}$']
OutputFilename='../Plots/RatioPlot_PionCS_200GeV_PHENIX_y0p35.pdf'
########################################################################################################################################################          
...
## Text
axs.text(1.1*x_min,0.93*y_max, '$\mathrm{pp},~\sqrt{s}=200\mathrm{~GeV}$\n'+'$|y|<0.35,(\pi^{+}+\pi^{-})/2$', horizontalalignment='left', verticalalignment='top')

## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
add_jetscape_logo('temp2',300,230,80,'_logo')
os.remove('temp.pdf')
