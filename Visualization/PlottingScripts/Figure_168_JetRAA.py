...
##--
file_pp_theory = [    '../200GeV/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allHadron_Cent_0-10_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt',                         '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allParton_Cent_0-10_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt',                  '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allHadron_Cent_0-10_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt', '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allParton_Cent_0-10_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt']

files_aa_theory = [    '../200GeV/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt',          '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allParton_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt',  '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_LiquefierEcut4T_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p5_FS_allParton_Cent_0-10_MatterLBT_withRecoil_LiquefierEcut4T_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt' ]     

label_theory = [r'$\mathrm{Hadronic~Jet~(Default)}$', '$\mathrm{Partonic~Jet~(Default)}$', '$\mathrm{Hadronic~Jet~(Liquefier~Ecut=4T)}$', '$\mathrm{Partonic~Jet~(Liquefier~Ecut=4T)}$' ]

files_data = ['']

label_data = ['$\mathrm{STAR~[PRC~102,~054913~(2020)]}$']
OutputFilename='../Plots/InclusiveJet_RAA_200GeV_STAR_R0p4_eta0p5_LiquefierEcut.pdf'
x_min =7.0
x_max =42
y_min = -0.2
y_max = 1.0
...
## Text
axs.text(x_min+1.2, y_max-0.27, '$\mathrm{AuAu~(0\\text{-}10\%),~\sqrt{\it{s}_{NN}}\!=\!200~GeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~R\!=\!0.4, |\eta_{jet}|<0.5$\n' , horizontalalignment='left', verticalalignment='bottom', fontsize=13)
