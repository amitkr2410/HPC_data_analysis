...
##--
file_denom = '../2760GeV/PythiaSingleHadronYield_pp_Pythia_CMS_2760GeV_EtaMax_1p0_FS_ChargedHadron.txt'

files_theory = [
                '../2760GeV/ColorlessSingleHadronYield_pp_Jetscape_CMS_2760GeV_EtaMax_1p0_FS_ChargedHadron.txt',
                '../2760GeV/PythiaSingleHadronYield_pp_Pythia_CMS_2760GeV_EtaMax_1p0_FS_ChargedHadron.txt']

label_theory = [r'$\mathrm{JETSCAPE~3.0}$',
                r'$\mathrm{PYTHIA~8}$']

files_data = ['../../ExperimentData_All/ExpData_CMS_2760_ChargedParticleYield_Eta1p0.dat']
#ATLAS PLB 790, 108 (2019)
label_data = ['$\mathrm{CMS~[EPJ~C72,~1945~(2012)]}$']
OutputFilename='../Plots/RatioPlot_ChargedParticleYield_2760GeV_CMS_eta1p0.pdf'
########################################################################################################################################################          
...
## Label for xy axes
axs.set_xlabel(r'$p_{\mathrm{T}}~\mathrm{(GeV)}$', fontsize=19)
axs.set_ylabel(r'$\mathrm{Ratio~to~PYTHIA~8}~\left[\frac{Ed^3 \sigma}{d^{3}p}\right]$', fontsize=19)
...
## Text
axs.text(1.5*x_min+5,0.93*y_max, '$\mathrm{pp},~\sqrt{s}=2.76\mathrm{~TeV}$\n'+'$|\eta|<1.0$'+'\n'+'$\mathrm{Inclusive\,charged\,particle}$', horizontalalignment='left', verticalalignment='top')

## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
add_jetscape_logo('temp2',325,240,80,'_logo')
os.remove('temp.pdf')
