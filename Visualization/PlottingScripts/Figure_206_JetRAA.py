...
files_aa_theory = [ '../ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '']
                   
label_theory = [r'$(2\!+\!1)\mathrm{D~medium}$', '$(\!3+\!1)\mathrm{D~medium}$']
