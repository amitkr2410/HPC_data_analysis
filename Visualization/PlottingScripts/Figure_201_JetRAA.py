...
files_aa_theory = ['../ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p25_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt','../ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p35_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt']
                   
label_theory = [r'$\alpha^{fix}_{s}=0.25$', '$\\alpha^{fix}_{s}=0.30$','$\\alpha^{fix}_{s}=0.35$']
...
OutputFilename='../Plots/Jet_RAA_5020GeV_Type5_different_Alphas_ALICE_R0p4_eta0p3.pdf'
x_min =50.0
x_max =150
y_min = -0.2
y_max = 1.0
...
axs.text(x_max-5, y_min+0.04,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $\\hat{q}\!\!=\!\!\\hat{q}^{run}_{HTL}f(Q^{2}),~Q_{sw}\!\!=\!\!2~\mathrm{GeV}$',horizontalalignment='right', verticalalignment='bottom')
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
