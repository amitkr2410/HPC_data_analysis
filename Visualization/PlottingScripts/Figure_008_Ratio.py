...
##--
file_denom = '../ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_BGS0_pTTrackMin_0p0GeV.txt'

files_theory = ['../PartonicJet/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allParton_Cent_0-10_Matter_pp_Partonic_BGS0_pTTrackMin_0p0GeV.txt']
...
OutputFilename='../Plots/RatioPlot_DJCS_PartonicJet_5020GeV_ALICE_R0p4_eta0p3.pdf'
########################################################################################################################################################          
...
axs.set_ylabel(r'$\frac{\mathrm{Partonic}}{Hadronic}~\left[\frac{d^2 \sigma}{dy dp_{\mathrm{T}}^{\mathrm{jet}}}\right]$', fontsize=19)
