...
OutputFilename='../Plots/QM_Jet_RAA_5020GeV_different_Qhat_ATLAS_CMS_R0p4_eta2p8.pdf'
x_min =80.0
x_max =1210
y_min = 0
y_max = 1.1
...
axs.legend(handles,labels,ncol=1,loc='upper left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.5, labelspacing=0.2, bbox_to_anchor=(0, 1.03), borderaxespad=0.8, handlelength=1.6, fontsize=12)
