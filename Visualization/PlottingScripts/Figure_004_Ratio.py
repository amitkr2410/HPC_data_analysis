...
##--
file_denom = '../JetCrossSection_R_0p4_AntikT_pp_Pythia_CMS_2760GeV_EtaJetMin_0p0_EtaMax_2p0_FS_allHadron.txt'

files_theory = [
                '../ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_CMS_2760GeV_EtaJetMin_0p0_EtaJetMax_2p0_FS_allHadron_Cent_0-5_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt',
                '../JetCrossSection_R_0p4_AntikT_pp_Pythia_CMS_2760GeV_EtaJetMin_0p0_EtaMax_2p0_FS_allHadron.txt']
...
OutputFilename='../Plots/RatioPlot_DJCS_2760GeV_CMS_R0p4_eta2p0.pdf'
########################################################################################################################################################          
