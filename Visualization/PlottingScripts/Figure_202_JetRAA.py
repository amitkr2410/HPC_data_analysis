...
files_aa_theory = ['../ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../DifferentQhat/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_RunningCouplingNewMoreStatistics_BGS1_pTTrackMin_0p0GeV.txt', '../DifferentQhat/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_alphas_0p25_Q0_2p0_LBTTc_160MeV_BGS1_pTTrackMin_0p0GeV.txt']
                   
label_theory = [r'$\hat{q}=\hat{q}^\mathrm{run}_\mathrm{HTL}f(Q^{2}),\alpha^\mathrm{fix}_\mathrm{s}\!=\!0.3$', r'$\hat{q}=\hat{q}^\mathrm{run}_\mathrm{HTL},\alpha^\mathrm{fix}_\mathrm{s}\!=\!0.25$', r'$\hat{q}=\hat{q}^\mathrm{fix}_\mathrm{HTL},\alpha^\mathrm{fix}_\mathrm{s}\!=\!0.25$']
...
OutputFilename='../Plots/Jet_RAA_5020GeV_different_Qhat_ALICE_R0p4_eta0p3.pdf'
x_min =50.0
x_max =150
y_min = -0.2
y_max = 1.0
...
## Text
axs.text(x_max-5, y_min+0.23, '$\mathrm{PbPb~(0\\text{-}10\%),~\sqrt{\it{s}_\mathrm{NN}}=5.02~TeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~ R=0.4,~|\\eta_{\mathrm{jet}}|<0.3$' , horizontalalignment='right', verticalalignment='bottom')
axs.text(x_max-5, y_min+0.04,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $Q_\mathrm{sw}\!\!=\!\!2~\mathrm{GeV}$',horizontalalignment='right', verticalalignment='bottom')
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
