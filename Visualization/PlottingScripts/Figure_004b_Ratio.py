...
##--
file_denom = '../2760GeV/JetCrossSection_R_0p4_AntikT_pp_Pythia_CMS_2760GeV_EtaJetMin_0p0_EtaMax_2p0_FS_allHadron.txt'

files_theory = ['../ColoredHadronization/JetCrossSection_R_0p4_AntikT_pp_Jetscape_CMS_2760GeV_EtaJetMin_0p0_EtaMax_2p0_FS_allHadron.txt',      '../2760GeV/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_CMS_2760GeV_EtaJetMin_0p0_EtaJetMax_2p0_FS_allHadron_Cent_0-5_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt',
                '../2760GeV/JetCrossSection_R_0p4_AntikT_pp_Pythia_CMS_2760GeV_EtaJetMin_0p0_EtaMax_2p0_FS_allHadron.txt']

label_theory = [r'$\mathrm{JETSCAPE~3.0~(Colored~Had.)}$', r'$\mathrm{JETSCAPE~3.0~ (Colorless~ Had.)}$',
                r'$\mathrm{PYTHIA~8}$']

files_data = ['../../ExperimentData_All/ExpData_CMS_2760_JetCrosssection_ppbaseline_Rp4_eta2.dat']
#ATLAS PLB 790, 108 (2019)
label_data = ['$\mathrm{CMS~[PRC~96,~015202~(2017)]}$']
OutputFilename='../Plots/RatioPlot_Colored_DJCS_2760GeV_CMS_R0p4_eta2p0.pdf'
########################################################################################################################################################          
...
## Text
axs.text(1.2*x_min,0.95*y_max, '$\mathrm{pp},~\sqrt{s}=2.76\mathrm{~TeV}$\n'+r'$\mathrm{anti\text{-}}k_\mathrm{T}$, $R\!=\!0.4$'+'\n'+'$|\eta_\mathrm{jet}|<2$', horizontalalignment='left', verticalalignment='top')
