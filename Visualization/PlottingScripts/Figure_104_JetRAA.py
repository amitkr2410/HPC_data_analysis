...
OutputFilename='../Plots/Jet_RAA_5020GeV_Type5_different_tau0_ATLAS_CMS_R0p4_eta2p8.pdf'
x_min =80.0
x_max =1210
y_min = 0
y_max = 1.2
...
axs.text(x_max-60, y_min+0.04,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $\\hat{q}\!\!=\!\!\\hat{q}^{run}_{HTL}f(Q^{2}),\\alpha^{fix}_{s}\!\!=\!\!0.3,Q_{sw}\!\!=\!\!2~\!\mathrm{GeV}$',horizontalalignment='right', verticalalignment='bottom',fontsize=14)
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
