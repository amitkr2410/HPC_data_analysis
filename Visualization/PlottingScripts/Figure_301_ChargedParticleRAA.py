...
files_aa_theory = ['../ColorlessSingleHadronYield_PbPb_Jetscape_CMS_5020GeV_EtaMax_1p0_FS_ChargedHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p25_Q0_2GeV_BGS1.txt', '../ColorlessSingleHadronYield_PbPb_Jetscape_CMS_5020GeV_EtaMax_1p0_FS_ChargedHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1.txt', '../ColorlessSingleHadronYield_PbPb_Jetscape_CMS_5020GeV_EtaMax_1p0_FS_ChargedHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p35_Q0_2GeV_BGS1.txt']
                   
#$\hat{q}=\hat{q}^{fix}_{HTL}f(Q^{2}), \mathrm{JS(MATTER+LBT) }$
label_theory = ['$\\alpha^{fix}_{s}=0.25$', '$\\alpha^{fix}_{s}=0.30$','$\\alpha^{fix}_{s}=0.35$']
...
OutputFilename='../Plots/ChargedParticle_RAA_Type5_different_alphas_5020GeV_CMS_0-10_eta1p0.pdf'
x_min =8.0
x_max =450
y_min = 0
y_max = 1.7
