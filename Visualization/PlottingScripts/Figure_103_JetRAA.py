...
files_aa_theory = ['../Tc150MeV_170MeV_tau0/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_Tc150MeV_BGS1_pTTrackMin_0p0GeV.txt', '../ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../Tc150MeV_170MeV_tau0/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_Tc170MeV_BGS1_pTTrackMin_0p0GeV.txt']
                   
label_theory = [r'$T_{c}=150~\mathrm{MeV}$', '$T_{c}=160~\mathrm{MeV}$','$T_{c}=170~\mathrm{MeV}$']
...
OutputFilename='../Plots/Jet_RAA_5020GeV_Type5_different_Tc_ATLAS_CMS_R0p4_eta2p8.pdf'
x_min =80.0
x_max =1210
y_min = 0
y_max = 1.2
...
axs.text(x_max-60, y_min+0.04,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $\\hat{q}\!\!=\!\!\\hat{q}^\mathrm{run}_\mathrm{HTL}f(Q^{2}),\\alpha^\mathrm{fix}_\mathrm{s}\!\!=\!\!0.3,Q_\mathrm{sw}\!\!=\!\!2~\!\mathrm{GeV}$',horizontalalignment='right', verticalalignment='bottom',fontsize=14)
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
