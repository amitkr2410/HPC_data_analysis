...
files_aa_theory =['../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type1_alphas_0p2_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allParton_Cent_0-10_MatterLBT_withRecoil_Type1_alphas_0p2_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt',
                  '../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type1_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allParton_Cent_0-10_MatterLBT_withRecoil_Type1_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt' ] 
                   
label_theory = [r'$\mathrm{Hadronic~Jet~(\alpha^{fix}_{s}=0.2)}$', r'$\mathrm{Partonic~Jet~(\alpha^{fix}_{s}=0.2)}$', r'$\mathrm{Hadronic~Jet~(\alpha^{fix}_{s}=0.3)}$', r'$\mathrm{Partonic~Jet~(\alpha^{fix}_{s}=0.3)}$']
...
OutputFilename='../Plots/Jet_RAA_5020GeV_Type1_PartonicJet_Cent0-10_ATLAS_CMS_R0p4_eta2p8.pdf'
x_min =80.0
x_max =1210
y_min = 0.0
y_max = 1.6
...
axs.text(x_max-60, y_min+0.08,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $\\hat{q}\!\!=\!\!\\hat{q}^{run}_{HTL}$,~$Q_{sw}\!=\!2~\!\mathrm{GeV}$', horizontalalignment='right', verticalalignment='bottom',fontsize=12)
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
