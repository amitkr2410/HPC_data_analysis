...
color_theory = ['red','red','blue','blue', 'blue','magenta']
...
##--
file_pp_theory = ['../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_BGS0.txt', '../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allParton_Cent_0-10_Matter_pp_Partonic_BGS0_pTTrackMin_0p0GeV.txt' ,  '../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_BGS0.txt','../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allParton_Cent_0-10_Matter_pp_Partonic_BGS0_pTTrackMin_0p0GeV.txt']

files_aa_theory =['../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p25_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allParton_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p25_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt',
                  '../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p35_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../PartonJetRAA_HadronJetRAA_DefaultTune/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allParton_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p35_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt' ] 
                   
label_theory = [r'$\mathrm{Hadronic~Jet~(\alpha^{fix}_{s}=0.25)}$', r'$\mathrm{Partonic~Jet~(\alpha^{fix}_{s}=0.25)}$', r'$\mathrm{Hadronic~Jet~(\alpha^{fix}_{s}=0.35)}$', r'$\mathrm{Partonic~Jet~(\alpha^{fix}_{s}=0.35)}$']
...
OutputFilename='../Plots/Jet_RAA_5020GeV_Type5_PartonicJet_Cent0-10_ATLAS_CMS_R0p4_eta2p8.pdf'
x_min =80.0
x_max =1210
y_min = 0.0
y_max = 1.6
...
for i, file in enumerate(files_aa_theory):
    ...
    axs.legend(handles,labels,ncol=1,loc='center left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.3, labelspacing=0.2, bbox_to_anchor=(0, 0.75), borderaxespad=0.8, handlelength=1.6, fontsize=12)


## Text
axs.text(x_max-80, y_min+0.28, '$\mathrm{PbPb~(0\\text{-}10\%),~\sqrt{\it{s}_{NN}}=5.02~TeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~ R=0.4,~|y_{\mathrm{jet}}|<2.8$' , horizontalalignment='right', verticalalignment='bottom',fontsize=12)
axs.text(x_max-60, y_min+0.08,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $\\hat{q}\!\!=\!\!\\hat{q}^{run}_{HTL}f(Q^{2})$,~$Q_{sw}\!=\!2~\!\mathrm{GeV}$', horizontalalignment='right', verticalalignment='bottom',fontsize=12)
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
