...
##--
file_pp_theory = '../200GeV/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p6_FS_ChargedHadron_Cent_0-10_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt'

files_aa_theory = ['../200GeV/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_STAR_200GeV_EtaJetMin_0p0_EtaJetMax_0p6_FS_ChargedHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt']
                   

label_theory = [r'$\hat{q}=\hat{q}^{\mathrm{run}}_{\mathrm{HTL}}f(Q^{2}), \mathrm{JS(MATTER+LBT) }$']


files_data = ['../../ExperimentData_All/ExpData_STAR_200_ChargedJetRAA_Centrality0-10_R0p4_eta0p6_unbiased.dat','../../ExperimentData_All/ExpData_STAR_200_ChargedJetRAA_Centrality0-10_R0p4_eta0p6_biased.dat']

label_data = ['$\mathrm{STAR, unbiased~[PRC~102,~054913~(2020)]}$','$\mathrm{STAR, biased~[PRC~102,~054913~(2020)]}$']

OutputFilename='../Plots/ChargedJet_RAA_200GeV_STAR_R0p4_eta0p6.pdf'
x_min =8.0
x_max =31
y_min = 0
y_max = 1.0
...
## Text
axs.text(x_min+0.6, y_max-0.28, '$\mathrm{AuAu~(0\\text{-}10\%),~\sqrt{\it{s}_{NN}}=200~GeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~ R=0.4$\n'+' $|\eta_{\mathrm{jet}}|<0.6,~p^{\mathrm{lead,ch}}_{\mathrm{T}}>5\mathrm{GeV}$' , horizontalalignment='left', verticalalignment='bottom')
