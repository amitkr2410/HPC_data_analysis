...
##--
file_denom = '../JetCrossSection_R_0p4_AntikT_pp_Pythia_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_BGS0_pTTrackMin_0p0GeV.txt'
...
files_theory = [
                ...
                '../JetCrossSection_R_0p4_AntikT_pp_Pythia_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_BGS0_pTTrackMin_0p0GeV.txt']

label_theory = [r'$\mathrm{JETSCAPE~3.0}$',
                r'$\mathrm{PYTHIA~8}$']

files_data = ['../../ExperimentData_All/ExpData_ALICE_5020_JetCrosssection_R0p4_eta0p3.dat']
#ATLAS PLB 790, 108 (2019)
label_data = ['$\mathrm{ALICE~[PRC~101,~034911~(2020)]}$']
OutputFilename='../Plots/RatioPlot_DJCS_5020GeV_ALICE_R0p4_eta0p3.pdf'
########################################################################################################################################################          
...
## Text
axs.text(1.1*x_min,0.93*y_max, '$\mathrm{pp},~\sqrt{s}=5.02\mathrm{~TeV}$\n'+r'$\mathrm{anti\text{-}}k_\mathrm{T}$, $R\!=\!0.4$'+'\n'+'$|\eta_\mathrm{jet}|<0.3,~p^{\mathrm{lead,ch}}_{\mathrm{T}}>7\mathrm{GeV}$', horizontalalignment='left', verticalalignment='top')
