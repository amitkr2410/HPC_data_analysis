...
##--
file_pp_theory = '../ColorlessJetCrossSection_R_0p4_AntikT_pp_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_BGS0_pTTrackMin_0p0GeV.txt'

files_aa_theory = ['../Tc150MeV_170MeV_tau0/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_tau0_0p3_BGS1_pTTrackMin_0p0GeV.txt',
                   '../ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../Tc150MeV_170MeV_tau0/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Alice_5020GeV_EtaJetMin_0p0_EtaJetMax_0p3_FS_allHadron_Cent_0-10_MatterLBT_withRecoil_tau0p9_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt']

label_theory = [r'$\tau_{0}=0.3~\mathrm{fm/c}$', '$\\tau_{0}=0.6~\mathrm{fm/c}$','$\\tau_{0}=0.9~\mathrm{fm/c}$']

files_data = ['../../ExperimentData_All/ExpData_ALICE_5020_JetRAA_Cent0-10_R0p4_eta0p3.dat']

label_data = ['$\mathrm{ALICE~[PRC~101,~034911~(2020)]}$']
OutputFilename='../Plots/Jet_RAA_5020GeV_Type5_different_tau0_ALICE_R0p4_eta0p3.pdf'
x_min =50.0
x_max =150
y_min = -0.2
y_max = 1.0
...
axs.legend(handles,labels,ncol=1,loc='center left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.1, labelspacing=0.2, bbox_to_anchor=(0, 0.82), borderaxespad=0.8, handlelength=1.6, fontsize=14)


## Text
axs.text(x_max-2, y_min+0.23, '$\mathrm{PbPb~(0\\text{-}10\%),~\sqrt{\it{s}_{NN}}=5.02~TeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~\!\!R\!\!=\!\!0.4,~|\\eta_{\mathrm{jet}}|<0.3,p^{\mathrm{lead}}_{\mathrm{T,ch}}>7\mathrm{GeV}$' , horizontalalignment='right', verticalalignment='bottom',fontsize=12)
axs.text(x_max-2, y_min+0.07,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $\\hat{q}\!\!=\!\!\\hat{q}^{run}_{HTL}f(Q^{2}),\\alpha^{fix}_{s}\!\!=\!\!0.3,~ \! Q_{sw}\!\!=\!\!2~\!\mathrm{GeV}$',horizontalalignment='right', verticalalignment='bottom',fontsize=12)
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
add_jetscape_logo('temp2',84,70,80,'_logo')
os.remove('temp.pdf')
