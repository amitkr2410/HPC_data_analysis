...
##
file_pp_theory = '../WithHoleSubtraction_5020GeV/ColorlessJetCrossSection_R_0p4_AntikT_ppPbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_50-60_Matter_pp_BGS0_pTTrackMin_0p0GeV.txt'

files_aa_theory =['../WithHoleSubtraction_5020GeV/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_50-60_MatterLBT_withRecoil_Type5_alphas_0p3_Q0_2GeV_BGS1_pTTrackMin_0p0GeV.txt', '../WithoutHoleSubtraction_5020GeV/ColorlessJetCrossSection_R_0p4_AntikT_PbPb_Jetscape_Atlas_5020GeV_EtaJetMin_0p0_EtaJetMax_2p8_FS_allHadron_Cent_50-60_Matter_Type5_alphas_0p3_Q0_2GeV_BGS0_pTTrackMin_0p0GeV.txt']
                   
label_theory = [r'$\mathrm{with~holes~subtraction}$', '$\mathrm{without~holes~subtraction}$']

files_data = ['../../ExperimentData_All/ExpData_ATLAS_5020_JetRAA_Cent50-60_R0p4_y2p8.dat']

label_data = ['$\mathrm{ATLAS~[PLB~790,~108~(2019)]}$']
#OutputFilename='../Plots/Jet_RAA_5020GeV_Type5_Effect_Holes_Cent50-60_ATLAS_R0p4_eta2p8.pdf'
OutputFilename='../Plots/Test_Jet_RAA_5020GeV_Type5_Effect_Holes_Cent50-60_ATLAS_R0p4_eta2p8.pdf'
x_min =40.0
x_max =445
y_min = 0.3
y_max = 1.3
...
axs.legend(handles,labels,ncol=1,loc='center left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.4, labelspacing=0.2, bbox_to_anchor=(0, 0.82), borderaxespad=0.8, handlelength=1.6, fontsize=14)


## Text
axs.text(x_max-30, y_min+0.2, '$\mathrm{PbPb~(50\\text{-}60\%),~\sqrt{\it{s}_{NN}}=5.02~TeV}$\n'+ '$\mathrm{anti}\\text{-}k_{\mathrm{T}},~ R=0.4,~|y_{\mathrm{jet}}|<2.8$' , horizontalalignment='right', verticalalignment='bottom',fontsize=14)
axs.text(x_max-30, y_min+0.04,'$~\mathrm{JS(MATTER\!+\!LBT)}$ \n $\\hat{q}\!\!=\!\!\\hat{q}^{run}_{HTL}f(Q^{2}),~\mathrm{\\alpha^{fix}_{s}\!\!=\!\!0.3}$,~$Q_{sw}\!=\!2~\!\mathrm{GeV}$', horizontalalignment='right', verticalalignment='bottom',fontsize=14)
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
add_jetscape_logo('temp2',76,70,75,'_logo')
os.remove('temp.pdf')
...
CommandName='echo '+ OutputFilename
