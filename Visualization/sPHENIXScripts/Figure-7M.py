...
##--
file_denom   = ["FF_RHIC_ChargedJetsYasuki_PP/fragf_hist_total_FragF_pt_jetr0.4_ptj10-30_rapj0.0-1.0_pt1.0-50.0_rap0.0-1.5.txt",
                "FF_RHIC_ChargedJetsYasuki_PP/fragf_hist_total_FragF_pt_jetr0.4_ptj30-50_rapj0.0-1.0_pt1.0-50.0_rap0.0-1.5.txt"
                ]

files_theory = [  "FF_RHIC_ChargedJetsYasuki_AuAu/fragf_hist_total_FragF_pt_jetr0.4_ptj10-30_rapj0.0-1.0_pt1.0-50.0_rap0.0-1.5.txt",
                  "FF_RHIC_ChargedJetsYasuki_AuAu/fragf_hist_total_FragF_pt_jetr0.4_ptj30-50_rapj0.0-1.0_pt1.0-50.0_rap0.0-1.5.txt"]
               

label_theory = [r'$ 10\mathrm{GeV}\!<\!p^{\mathrm{ch,jet}}_{\mathrm{T}}<30\mathrm{GeV}$',
                r'$ 30\mathrm{GeV}\!<\!p^{\mathrm{ch,jet}}_{\mathrm{T}}<50\mathrm{GeV}$']
...
OutputFilename='Dz_Pt_Merged_ChargedJets_0-10.pdf'
########################################################################################################################################################          
...
#axs[0].yaxis.set_major_locator(mpl.ticker.MultipleLocator(10))
axs[1].xaxis.set_major_locator(mpl.ticker.MultipleLocator(10.0))
...
## Label for xy axes
axs[1].set_xlabel(r'$p_{\mathrm{T}}(\mathrm{GeV})$', fontsize=18)
axs[0].set_ylabel(r'$D(p_{\mathrm{T}})$', fontsize=18)
...
axs[0].legend(handles,labels,ncol=1,loc='lower left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.05, bbox_to_anchor=(0.38, 0.45), borderaxespad=0.5, handlelength=1.6, fontsize=14)

## Text
axs[0].text(39,1000.985, '$\sqrt{s_{NN}}\!=\!200\!\mathrm{~GeV},\mathrm{AuAu:~}0\mathrm{-}10\%$\n'+r'$\mathrm{anti\text{-}}k_\mathrm{T},R\!=\!0.4, p^{\mathrm{trk}}_{\mathrm{T}}\!>\!1\mathrm{GeV}$', horizontalalignment='right', verticalalignment='top')
...
axs.xaxis.set_major_locator(mpl.ticker.MultipleLocator(10.0))
...
axs.set_ylabel(r'$D(p_{\mathrm{T}})$', fontsize=18)
axs.set_ylabel(r'$\mathrm{AuAu/pp}~[D(p_{\mathrm{T}})]$', fontsize=18)
...
for i, file in enumerate(files_theory):
  ...
  handles.append(tl[0]) 
  labels.append(label_theory[i])   
axs.legend(handles,labels,ncol=1,loc='lower left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.05, bbox_to_anchor=(0.04, 0.52), borderaxespad=0.5, handlelength=1.7, fontsize=13)

## Text
axs.text(2,2.7, '$\sqrt{s_{NN}}\!=\!200\!\mathrm{~GeV},\mathrm{AuAu:~}0\mathrm{-}10\%$\n'+r'$\mathrm{anti\text{-}}k_\mathrm{T},R\!=\!0.4, p^{\mathrm{trk}}_{\mathrm{T}}\!>\!1\mathrm{GeV}$', horizontalalignment='left', verticalalignment='top')
## Generate PDF File
plt.tight_layout()
plt.savefig('temp2')
## Add Logos
