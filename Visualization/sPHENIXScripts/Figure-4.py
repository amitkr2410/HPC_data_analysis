...
##--
file_denom   = ["MyXML/Output_ChargedJets/SoftDropGroom_hist_total_SoftDropGroom_thetaG_jetr0.2_ptj30-50_rapj0.0-0.7_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt",
                "MyXML/Output_ChargedJets/SoftDropGroom_hist_total_SoftDropGroom_thetaG_jetr0.4_ptj30-50_rapj0.0-0.5_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt"]

files_theory = [  "MyXML/Output_ChargedJetsAuAu/SoftDropGroom_hist_total_SoftDropGroom_thetaG_jetr0.2_ptj30-50_rapj0.0-0.7_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt",
                 "MyXML/Output_ChargedJetsAuAu/SoftDropGroom_hist_total_SoftDropGroom_thetaG_jetr0.4_ptj30-50_rapj0.0-0.5_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt"]
...
OutputFilename='ThetaG_30GeV_50GeV_0-10.pdf'
########################################################################################################################################################          
...
## Label for xy axes
axs[1].set_xlabel(r'$\theta_{g}$', fontsize=18)
axs[0].set_ylabel(r'$\frac{1}{\sigma_{\mathrm{jet,inc}}}\frac{d \sigma}{d\theta_{g}}$', fontsize=18)
...
axs[0].legend(handles,labels,ncol=1,loc='lower left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.05, bbox_to_anchor=(0.35, .50), borderaxespad=0.5, handlelength=1.6, fontsize=14)

## Text
axs[0].text(0.9485,3.8, '$\sqrt{s_{NN}}\!=\!200\!\mathrm{~GeV},\mathrm{AuAu:~}0\mathrm{-}10\%$\n'+r'$\mathrm{anti\text{-}}k_\mathrm{T}, \mathrm{Charged~jets}$'+'\n'+'$30\mathrm{GeV}\!<\!p^{\mathrm{ch,jet}}_{\mathrm{T}}\!<\!50\mathrm{GeV}$', horizontalalignment='right', verticalalignment='top')
