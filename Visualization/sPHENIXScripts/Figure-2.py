...
##--
file_denom   = ["MyXML/Output_ChargedJets/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.2_ptj30-50_rapj0.0-0.7_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt" ,
...
files_theory = [  "MyXML/Output_ChargedJetsAuAu/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.2_ptj30-50_rapj0.0-0.7_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt"
                , "MyXML/Output_ChargedJetsAuAu/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.4_ptj30-50_rapj0.0-0.5_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt" ]
               

label_theory = [r'$R=0.2, |\eta_{\mathrm{ch,jet}}|<0.7$',
                r'$R=0.4, |\eta_{\mathrm{ch,jet}}|<0.5$']
...
OutputFilename='Zg_30GeV_50GeV_0-10.pdf'
########################################################################################################################################################          
...
axs.set_ylabel(r'$\mathrm{Ratio~to~PYTHIA~8.230}~\left[\frac{d^2 \sigma}{dy dp_{\mathrm{T}}^{\mathrm{jet}}}\right]$', fontsize=16)
...
for i, file in enumerate(files_theory):
  ...
  handles.append(tl[0]) 
  labels.append(label_theory[i])   
axs.legend(handles,labels,ncol=1,loc='lower left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.05, bbox_to_anchor=(0.1, 0), borderaxespad=0.5, handlelength=1.6, fontsize=11)

## Text
#axs.text(1.4*x_min+50,0.95*y_max, '$\mathrm{pp},~\sqrt{s}=5.02\mathrm{~TeV}$\n'+r'$\mathrm{anti\text{-}}k_\mathrm{T}$, $R\!=\!0.4$'+'\n'+'$|y_\mathrm{jet}|<0.3$', horizontalalignment='left', verticalalignment='top')
"""
## Generate PDF File
#plt.tight_layout()
#plt.savefig('temp2')
