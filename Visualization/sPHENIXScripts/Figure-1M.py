...
##--
file_denom   = ["MyXML/Output_ChargedJets/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.2_ptj10-30_rapj0.0-0.7_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt" ,
                "MyXML/Output_ChargedJets/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.4_ptj10-30_rapj0.0-0.5_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt",
                "MyXML/Output_ChargedJets/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.2_ptj30-50_rapj0.0-0.7_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt",
                "MyXML/Output_ChargedJets/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.4_ptj30-50_rapj0.0-0.5_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt"]

files_theory = [  "MyXML2/Output_ChargedJetsAuAu/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.2_ptj10-30_rapj0.0-0.7_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt"
                  , "MyXML2/Output_ChargedJetsAuAu/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.4_ptj10-30_rapj0.0-0.5_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt",
                "MyXML2/Output_ChargedJetsAuAu/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.2_ptj30-50_rapj0.0-0.7_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt"
                  , "MyXML2/Output_ChargedJetsAuAu/SoftDropGroom_hist_total_SoftDropGroom_zG_jetr0.4_ptj30-50_rapj0.0-0.5_pt0.1-200.0_rap0.0-1.0_beta0.00_zCut0.20.txt"]
...
OutputFilename='Zg_Merged_0-10_copy.pdf'
########################################################################################################################################################          
...
axs[1].xaxis.set_major_locator(mpl.ticker.MultipleLocator(0.1))
axs[1].xaxis.set_minor_locator(mpl.ticker.MultipleLocator(0.05))
axs[1].yaxis.set_major_locator(mpl.ticker.MultipleLocator(0.25))
axs[1].yaxis.set_minor_locator(mpl.ticker.MultipleLocator(0.1))
'''
## Label for xy axes
#axs[1].set_xlabel(r'$z_{g}$', fontsize=18)
#axs[0].set_ylabel(r'$\frac{1}{\sigma_{\mathrm{jet,inc}}}\frac{d \sigma}{dz_{g}}$', fontsize=18)
...
#axs[0].legend(handles,labels,ncol=1,loc='lower left',edgecolor='none', frameon=True, facecolor='none', handletextpad=0.4, handleheight=1.8, labelspacing=0.05, bbox_to_anchor=(0, 0), borderaxespad=0.5, handlelength=1.6, fontsize=14)

## Text
#axs[0].text(0.485,5, '$\sqrt{s_{NN}}\!=\!200\!\mathrm{~GeV},\mathrm{AuAu:~}0\mathrm{-}10\%$\n'+r'$\mathrm{anti\text{-}}k_\mathrm{T}, \mathrm{Charged~jets}$'+'\n'+'$10\mathrm{GeV}\!<\!p^{\mathrm{ch,jet}}_{\mathrm{T}}\!<\!30\mathrm{GeV}$', horizontalalignment='right', verticalalignment='top')
...
axs.xaxis.set_major_locator(mpl.ticker.MultipleLocator(0.1))
axs.xaxis.set_minor_locator(mpl.ticker.MultipleLocator(0.05))
axs.yaxis.set_major_locator(mpl.ticker.MultipleLocator(0.25))
axs.yaxis.set_minor_locator(mpl.ticker.MultipleLocator(0.1))



## Label for xy axes
axs.set_xlabel(r'$z_{g}$', fontsize=18)
#axs.set_ylabel(r'$\frac{1}{\sigma_{\mathrm{jet,inc}}}\frac{d \sigma}{dz_{g}}$', fontsize=18)
axs.set_ylabel(r'$\mathrm{AuAu/pp}~[\frac{1}{\sigma_{\mathrm{jet,inc}}}\frac{d \sigma}{dz_{g}}]$', fontsize=18)
...
## Text
axs.text(0.22,1.9, '$\sqrt{s_{NN}}\!=\!200\!\mathrm{~GeV},\mathrm{AuAu:~}0\mathrm{-}10\%$\n'+r'$\mathrm{anti\text{-}}k_\mathrm{T}, \mathrm{Charged~jets}$', horizontalalignment='left', verticalalignment='top')
